...
import { Box, Drawer, List, ListItem, ListItemText, Toolbar, AppBar, Typography, Divider, Button, patch } from '@mui/material';
import { DollarSign, Home, LogOut, Package, User, FilePenLine  } from 'lucide-react';
import { Link, Outlet, useLocation } from 'react-router-dom';

const drawerWidth = 240; // Ancho del menú ajustado
      ...
      >
        <Toolbar sx={{ justifyContent: 'space-between' }}>
          ...
          <Button
            ...
            variant="contained"
            color="error"
            startIcon={<LogOut size={20} />} // Icono de salir
            sx={{
              backgroundColor: '#D32F2F', // Rojo más intenso
              '&:hover': {
                backgroundColor: '#C62828', // Rojo más oscuro al hacer hover
              },
              fontWeight: 'bold',
              color:'white',
        ...
        <Box sx={{ overflow: 'auto', display: 'flex', flexDirection: 'column', height: '100%' }}>
          ...
          <List sx={{ flexGrow: 1 }}>
            {[
              ...
              { text: 'Cotizacion', icon: <FilePenLine />, path: '/proforms' },
